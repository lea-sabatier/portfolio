...
|--|--|--|--|--|
|Python|This is an end-of-study internship carried out at INSEP (Paris) to study the reliability and validity of 10 Favero Assioma Duo power meters. | This is a research topic. You will find the different scripts in the following link, but the conclusions and graphs cannot be presented for reasons of confidentiality. | <ul> <li> Data automation </li> <li> Data preparation </li> <li> Data cleaning </li> <li> Statistical testing </li> <li> Data visualization </li> <li> Data interpretation </li> </ul> |[README & Script](https://github.com/lea-sabatier/portfolio/tree/main/Projects/INSEP_internship)|
