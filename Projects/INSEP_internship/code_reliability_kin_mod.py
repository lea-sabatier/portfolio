...
with pd.ExcelWriter('C:/Users/Sabatier Léa/Documents/Stage INSEP/Donnees_test/RESULTATS/fichier_reliability_kin_avant_powerbi2.xlsx') as writer: #mettre f devant nom du fichier pour pouvoir insérer des expressions dans des chaînes de caractères {} 
